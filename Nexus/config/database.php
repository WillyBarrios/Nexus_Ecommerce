...
return [
    ...
    */
    ...
    'connections' => [
        ...
        // Conexión solo lectura para Nexus (usa DB_READ_* y cae a DB_* si no existe)
        'nexus_read' => [
            'driver' => env('DB_READ_DRIVER', env('DB_CONNECTION', 'mariadb')),
            'url' => env('DB_URL'),
            ...
            'charset' => env('DB_CHARSET', 'utf8mb4'),
            'collation' => env('DB_COLLATION', 'utf8mb4_unicode_ci'),
            'prefix' => env('DB_READ_PREFIX', env('DB_PREFIX', '')),
            'prefix_indexes' => true,
            'strict' => true,
            'engine' => null,
            'options' => extension_loaded('pdo_mysql') ? array_filter([
